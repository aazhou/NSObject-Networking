...
- (AFHTTPRequestOperationManager *)sharedOperationManager {
    if (!self.operationManager) {
        ...
        [manager.requestSerializer setValue:[AppUtils userAgent] forHTTPHeaderField:@"User-Agent"];
        [manager.requestSerializer setValue:[AppUtils deviceCode] forHTTPHeaderField:@"X-Device"];
        [manager.requestSerializer setValue:[AppUtils platformString] forHTTPHeaderField:@"X-Model"];
        [manager.requestSerializer setValue:[AppUtils networkString] forHTTPHeaderField:@"X-Network"];
        [manager.requestSerializer setValue:@"1" forHTTPHeaderField:@"X-EP"];
    ...
    if (auth_token) {
        [self.operationManager.requestSerializer setValue:auth_token forHTTPHeaderField:@"Authorization"];
    }
    else {
